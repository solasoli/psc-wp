...
require_once('wp-includes/update-profile.php');
?>
							...
							<div class="col-md-6">
								...
								<div class="form-group row">
									...
									<div class="form-group row">
										...
										<div class="col-sm-2">
											<input type="text" class="form-control woocommerce-Input woocommerce-Input--text" id="zipcode" placeholder="zipcode" value="<?php the_author_meta( 'zipcode', $current_user->ID ); ?>">
										</div>
