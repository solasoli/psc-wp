...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
    ...
    <div class="order-history shoping-cart woocommerce-cart-form__contents">
        ...
        <div class="cart-bottom">
            <div class="coupon-block">
                ...
                <input class="coupon-button" name="apply_coupon" value="APPLY COUPON" type="submit">
            </div>
            <div class="subtotal-block">
                <ul>
                    <li>
                        <div class="pull-left">Subtotal</div>
                        <div class="pull-right">US$76</div>
                   </li>
                   <li>
                        <div class="pull-left">TOTAL</div>
                        <div class="pull-right">US$76.00</div>
                   </li>
                </ul>
                <div class="make-payment">
                    <a href="#" class="primary-button">PROCEED TO CHECKOUT</a>
                </div>
            </div>
        </div>
    </div>
